...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('dashboard.apartment.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control" name="room_number" id="room_number" type="number" required="" value="">
                </div>
            </div>
