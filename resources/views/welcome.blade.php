                            ...
                            <div class="main__slider-frame" data-swiper-parallax-opacity="0">
                                <div class="main__slider-photo" data-swiper-parallax="-100" data-swiper-parallax-scale="1.2">
                                    <div class="main__bg main__light">
                                        <img src="/img/bg/bg-main.jpg" alt="photo">
                                    </div>
                                    <!-- /.main__bg -->
                                    <div class="main__bg main__dark">
                                        <img src="/img/bg/genplan.jpg" alt="photo">
                                    </div>
                                    <!-- /.main__bg -->
                                </div>
                                <div class="main__slider-caption general__container" data-swiper-parallax="0" data-swiper-parallax-opacity="0">
                                    ...
                                    <div class="main__slider-description" data-swiper-parallax="200">
                                        ...
                                        <div class="content">
                                            <h2 class="content__title general-M">ИЗЫСКАННЫЕ ФАСАДЫ</h2>
                                            <!-- /.main__title -->
                                            <div class="content__descr general-R">
                                                “Комплекс апартаментов такого объема и размера, как Parkent Gardens, — это нечто среднее между особняком и городским домом. Это, скорее, мраморный дворец: он покоится на гранитном пьедестале, но отделан дорогим юрским мрамором.”
                                            </div>
                                            <!-- /.main__descr -->
                                        </div>
                                    </div>
            ...
            <div class="general__container">
                <div class="contacts" data-aos="fade-right">
                    ...
                    <div class="contacts__container">
                        ...
                        <!-- /.messengers -->
                        <a href="" class="contacts__download">
